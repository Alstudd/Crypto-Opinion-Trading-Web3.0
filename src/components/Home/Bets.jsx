...
import "swiper/css";
import betDetails from "../../data/betDetails";
...
const SliderButtons = () => {
  ...
  return (
    <div className="flex justify-center gap-[1rem] pt-4">
      <button
        className="text-[1.2rem] py-[0.2rem] px-[0.8rem] text-[#00b386] border-none rounded-[5px] bg-green-100 cursor-pointer"
